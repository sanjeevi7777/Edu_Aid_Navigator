  ...
  return (
    <section >
      ...
      <a href="#" className="flex fixed top-5 left-10 mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
        ...
        <div className="w-full bg-white rounded-lg shadow dark:border-gray-900 md:mt-0 sm:max-w-md xl:p-0  dark:bg-transparent"style={{
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                Already have an account? <a href="#" className="font-medium text-primary-600 hover:underline dark:text-teal-700">Login here</a>
              </p>
            </form>
          </div>
        </div>
