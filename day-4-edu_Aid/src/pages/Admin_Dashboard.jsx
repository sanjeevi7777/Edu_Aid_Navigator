...
import { Table, Thead, Tbody, Tr, Th, Td ,Button,Text,Heading} from '@chakra-ui/react';
import {
  Modal,
  ModalOverlay,
  ModalContent,
  ...
  return (
    ...
    <div className='fixed z-50'>
      ...
      <div className='bg-gray-700 ml-64 h-full w-full'>
        <div className='bg-gray-700 text-3xl p-2 m-2 text-white rounded font-bold'>Welcome back <span className='text-teal-500'>Sanjeevi.,</span></div>
        <div style={{ display: 'flex', }}>
          
          <div className='bg-orange-200 p-2 text-black text-center text-2xl' style={{ width: '50%', margin: 5, marginBottom: 0, borderRadius:10 }}>
          ...
          <div className='bg-blue-200 p-2 text-black text-center text-2xl' style={{ width: '50%', margin: 5, marginBottom: 0, borderRadius:10 }}>
          <div className='card w-38'>
           Number of Student Enrolled<br/>
               <span className='font-bold '>11450</span>
...
<Heading mt='10' size='lg' color='white' ml='5'>Enrolled Students</Heading>
          <div>
          <Table variant='simple' mt={6} p={1}>
          <Thead>
            <Tr backgroundColor='gray.700'>
              <Th color='white'>Course Name</Th>
              <Th color='white'>Enrolled Date</Th>
          ...
          <Tbody>
            {courses.map((course) => (
              <Tr key={course.id} backgroundColor={course.id % 2 === 0 ? 'gray.300' : 'gray.400'}>
                ...
                <Td>{course.totalStudents} students</Td>
                <Td display='flex'>
                  
                  <Button  style={{backgroundColor:'teal',color:'white'}} size="xs" onClick={onOpen}>
                    View Students
                  </Button>
                </Td>
              </Tr>
        ...
        <ModalContent>
          <ModalHeader backgroundColor='gray.800' color='white' textAlign='center'>Students List</ModalHeader>
...
jn                   {/* <Td className='text-gray-400'>{completed}</Td> */}
              ...
              {students.map((rank) => {
                  if (rank.id % 2 === 0) {
                    return (
                      <Tr className='bg-gray-900' key={rank.id}>
                        <Td className='text-white'>{rank.name}</Td>
                        <Td className='text-white'>{rank.date}</Td>
                        {/* <Td className='text-white'>{rank.ccourses}</Td> */}
                        {/* <Td className='text-white'>{rank.points}</Td> */}
                      </Tr>
                    );
                  } else {
                    return ( <Tr className='bg-gray-700' key={rank.id}>
                    <Td className='text-white'>{rank.name}</Td>
                    <Td className='text-white'>{rank.date}</Td>
                    {/* <Td className='text-white'>{rank.ccourses}</Td> */}
                    {/* <Td className='text-white'>{rank.points}</Td> */}
